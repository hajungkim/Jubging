...
public class ArticleController {
    ...
    public ControllerResponse saveArticle(@RequestBody ArticleSaveRequestDto requestDto){
        ...
        try {
            ...
            response = new ControllerResponse("fail", "게시글 등록 실패");
        }
    ...
    public ControllerResponse detailArticle(@PathVariable int article_id){
        ...
        try{
            ...
            response = new ControllerResponse("fail", "게시글 조회 실패");
        }
    ...
    public ControllerResponse updateArticle(@RequestBody ArticleUpdateRequestDto requestDto){
        ...
        try{
            ...
            response = new ControllerResponse("fail", "게시글 수정 실패");
        }
        return response;
    }
    ...
    public ControllerResponse deleteArticle(@PathVariable int article_id){
        ...
        try {
            ...
            response = new ControllerResponse("fail", "게시글 삭제 실패");
        }
